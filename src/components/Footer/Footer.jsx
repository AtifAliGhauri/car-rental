      ...
      <Row>
        ...
        <Col lg='3' md='4' sm='6'>
            <div className='mb-4'>
              ...
              <p className='office__info'>234 Gulberg, Lahore, Pakistan</p>
              <p className='office__info'>Phone: +35623785</p>
              <p className='office__info'>Email: asb@gmail.com</p>
        ...
        <Col lg='12'>
          <div className='footer__bottom'>
              ...
              Developed by Atif ALi . All rights Reserved.
              </p>
          </div>
        </Col>
      </Row>
